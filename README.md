...
|--|--|--|--|--|
| [The Shallot](https://github.com/jebax/TheShallotSummary) | With only a weekend to create a front-end, single-page app using two different news APIs, and with zero frameworks allowed on top of pure JS, I created my own testing framework to test drive The Shallot - an unoriginally named news summary app with unoriginal news (but the code is nice).<br/>*I redid this project in React, have a look [here](https://github.com/jebax/TheShallotReact).* | 3 days | JavaScript, HTML/CSS | Custom framework |
